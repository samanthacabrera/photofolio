        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          ...
          <div className="md:col-span-8 flex flex-col gap-3">
            <a href="/photofolio" className="uppercase flex flex-col">
              <span className="text-white/80 hover:text-white transition text-4xl md:text-8xl font-extralight tracking-wide">
                JM <span className="opacity-80 -ml-2 md:-ml-8">Photography</span>
              </span>
            </a>
